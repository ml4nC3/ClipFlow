...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.setMinimumSize(QtCore.QSize(760, 830))
        MainWindow.setMaximumSize(QtCore.QSize(760, 830))
        font = QtGui.QFont()
...
"color: rgb(255, 255, 255);")
        ...
        self.gb_events.setGeometry(QtCore.QRect(10, 550, 741, 251))
        ...
        self.btn_event_delete.setGeometry(QtCore.QRect(310, 200, 201, 31))
        ...
        self.btn_event_delete_all.setGeometry(QtCore.QRect(540, 200, 191, 31))
        self.btn_event_delete_all.setObjectName("btn_event_delete_all")
        self.tree_events = QtWidgets.QTreeWidget(self.gb_events)
        self.tree_events.setGeometry(QtCore.QRect(310, 20, 421, 171))
        ...
        self.gb_serial.setGeometry(QtCore.QRect(540, 320, 211, 211))
        ...
        self.lineEdit_com_port.setGeometry(QtCore.QRect(90, 130, 111, 31))
        ...
        self.lbl_com_status.setGeometry(QtCore.QRect(10, 20, 71, 21))
        self.lbl_com_status.setAlignment(QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft|QtCore.Qt.AlignVCenter)
        self.lbl_com_status.setObjectName("lbl_com_status")
        self.lbl_com_status_text = QtWidgets.QLabel(self.gb_serial)
        self.lbl_com_status_text.setGeometry(QtCore.QRect(10, 40, 191, 71))
        ...
        self.spinBox_baudrate.setGeometry(QtCore.QRect(90, 170, 111, 31))
...
"color: rgb(240, 240, 240);")
        ...
        self.gb_fsm_info.setGeometry(QtCore.QRect(540, 120, 211, 181))
        ...
        self.lbl_fsm_state_value.setGeometry(QtCore.QRect(80, 20, 121, 31))
        self.lbl_fsm_state_value.setObjectName("lbl_fsm_state_value")
        self.lbl_fsm_state_text = QtWidgets.QLabel(self.gb_fsm_info)
        self.lbl_fsm_state_text.setGeometry(QtCore.QRect(10, 20, 61, 31))
        ...
        self.lbl_leak_time_text.setGeometry(QtCore.QRect(10, 50, 101, 31))
        ...
        self.lbl_leak_vol_limit_value = QtWidgets.QLabel(self.gb_fsm_info)
        self.lbl_leak_vol_limit_value.setGeometry(QtCore.QRect(120, 110, 81, 31))
        self.lbl_leak_vol_limit_value.setObjectName("lbl_leak_vol_limit_value")
        self.lbl_leak_vol_limit_text = QtWidgets.QLabel(self.gb_fsm_info)
        self.lbl_leak_vol_limit_text.setGeometry(QtCore.QRect(10, 110, 101, 31))
        self.lbl_leak_vol_limit_text.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.lbl_leak_vol_limit_text.setObjectName("lbl_leak_vol_limit_text")
        self.lbl_index_value = QtWidgets.QLabel(self.gb_fsm_info)
        self.lbl_index_value.setGeometry(QtCore.QRect(120, 140, 81, 31))
        self.lbl_index_value.setObjectName("lbl_index_value")
        self.lbl_index_text = QtWidgets.QLabel(self.gb_fsm_info)
        self.lbl_index_text.setGeometry(QtCore.QRect(10, 140, 101, 31))
        self.lbl_index_text.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.lbl_index_text.setObjectName("lbl_index_text")
        self.gb_fsm_info_2 = QtWidgets.QGroupBox(self.centralwidget)
        self.gb_fsm_info_2.setGeometry(QtCore.QRect(540, 20, 211, 91))
        ...
        self.lbl_stable_flow_value.setGeometry(QtCore.QRect(130, 50, 51, 31))
        ...
        self.lbl_null_flow_value.setGeometry(QtCore.QRect(130, 20, 51, 31))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.lbl_leak_time_text.setText(_translate("MainWindow", "Tps fuite (s) : "))
        self.lbl_leak_vol_value.setText(_translate("MainWindow", "0000,000"))
        self.lbl_leak_time_value.setText(_translate("MainWindow", "000"))
        self.lbl_leak_vol_text.setText(_translate("MainWindow", "Vol fuite (L) : "))
        self.lbl_leak_vol_limit_value.setText(_translate("MainWindow", "0000,000"))
        self.lbl_leak_vol_limit_text.setText(_translate("MainWindow", "Vol limite (L) : "))
        self.lbl_index_value.setText(_translate("MainWindow", "0000,000"))
        self.lbl_index_text.setText(_translate("MainWindow", "Index (L) : "))
        self.gb_fsm_info_2.setTitle(_translate("MainWindow", "Débit"))
        self.lbl_stable_flow_value.setText(_translate("MainWindow", "Vrai"))
        self.lbl_nul_flow_text.setText(_translate("MainWindow", "Débit est nul : "))
        self.lbl_stable_flow_text.setText(_translate("MainWindow", "Débit est stable : "))
