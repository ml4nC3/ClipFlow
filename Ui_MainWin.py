...
"color: rgb(240, 240, 240);")
        ...
        self.gb_fsm_info.setGeometry(QtCore.QRect(230, 0, 321, 61))
        self.gb_fsm_info.setStyleSheet("color: rgb(134, 136, 135);")
        self.gb_fsm_info.setObjectName("gb_fsm_info")
        self.lbl_nul_flow_text = QtWidgets.QLabel(self.gb_fsm_info)
        self.lbl_nul_flow_text.setGeometry(QtCore.QRect(11, 19, 71, 16))
        ...
        self.lbl_stable_flow_text = QtWidgets.QLabel(self.gb_fsm_info)
        self.lbl_stable_flow_text.setGeometry(QtCore.QRect(11, 37, 71, 16))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.lbl_leak_vol_text.setText(_translate("MainWindow", "Tps fuite :"))
        self.lbl_leak_vol_value.setText(_translate("MainWindow", "0"))
        self.lbl_leak_time_value.setText(_translate("MainWindow", "0"))
        self.lbl_leak_time_text.setText(_translate("MainWindow", "Vol fuite :"))
